...
import javax.swing.*;
import java.io.*;
public class ColorDlg extends java.awt.Frame implements AdjustmentListener,ItemListener,ActionListener
{
	public ColorDlg()
	{
		super("Choose Color");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		try
			{	
			colorinfo=new java.io.File("/home/girish/bgcolor.info");
