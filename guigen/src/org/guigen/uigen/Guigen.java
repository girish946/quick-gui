...
public class Guigen extends java.awt.Panel implements java.awt.event.ActionListener
{
	...
	//	iconi=new javax.swing.ImageIcon("java_icon.gif");
		...
		Note=new java.awt.Label("package name");
                package_name=new java.awt.TextField(20);
		three_two.setLayout(new java.awt.BorderLayout());
		three_two.add(Note,java.awt.BorderLayout.NORTH);
                three_two.add(package_name,java.awt.BorderLayout.CENTER);
...
//	iu=new URLGen("java_icon.gif");
        ...
        colorpanel =new Color_Panel(this);
...
//			}
		...
		if (e.getSource()==Color_button)
		{
			...
			org.guigen.uigen.AppUIMainTopComponent.showPanel(colorpanel);
                        org.guigen.uigen.AppUIMainTopComponent.currentPanel=colorpanel;
			//System.out.println(cdl.getbgColor().toString());
			boolean b1=colorpanel.getOk();
			System.out.println(b1);
			if (b1==false)
			{
				bgcol=colorpanel.getbgColor();
...
//			repaint();
	...
	public void write_file() throws java.io.FileNotFoundException,java.lang.NullPointerException
	{
		...
		{
			java.io. File outputfile=new java.io.File(project_path+tf[0].getText()+".java");
...
//	private java.awt.MenuItem Save_info;
	...
	private	java.awt.Color bgcol,fgcol;
        static Color_Panel colorpanel;
        java.awt.TextField package_name;
        static String project_path="/home/girish/NetBeansProjects/DesktopApplication1/src/girish/";
}
